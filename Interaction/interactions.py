...
class InteractionsControl:
    ...
    def interaction_translation_vel(
        ...
        def calculate_braking_angles(dv_x, dv_y, max_attitude=20.0):
            """Compute pitch/roll to emulate a virtual mass.
            ...
            sin_pitch = (1 - inv_mass_ratio) * dv_x / (_G * dt)
            sin_roll  = -(1 - inv_mass_ratio) * dv_y / (_G * dt)
