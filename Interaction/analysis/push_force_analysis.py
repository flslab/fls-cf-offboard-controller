...
def main(logfile, label=None, show_plot=False):
    ...
    _ACC_MIN = 0.01  # m/s²  — threshold below which ratio is suppressed
...
if __name__ == "__main__":
    ...
    main(str(_project_root / 'logs' / 'lb11_translation_2026-04-15_19-01-32.json'), label="300g", show_plot=False)
