...
class DefaultConfigTests(unittest.TestCase):
    def test_release_braking_handoff_uses_practical_speed_threshold(self):
        ...
        self.assertEqual(
            handoff["coast_handoff_max_lateral_speed_m_s"], 0.15
        )
        self.assertEqual(
        ...
        self.assertEqual(
            handoff["coast_state_max_implied_acceleration_m_s2"], 20.0
        )
        self.assertEqual(handoff["coast_state_max_sample_gap_s"], 0.05)
