    ...
    def orchestrated_mission(self, mission_index):
        ...
        if follow:
            ...
            if mission_setting.get("test"):
                ...
                self._fade_pid_values(self.cfg.PID_VALUES_FLOWDECK, self.cfg.XY_POS_VEL_PID_VALUES)
            ...
            if mission_setting.get("test"):
                ...
                self._fade_pid_values(self.cfg.XY_POS_VEL_PID_VALUES, self.cfg.PID_VALUES_FLOWDECK)
