...
def xy_tune_pattern(scf):
    ...
    for _ in range(3):
        commander.go_to(1.5, 0, 1, 0, flight_time, relative=False)
        time.sleep(flight_time)
    ...
    for _ in range(3):
        commander.go_to(0, 1.5, 1, 0, flight_time, relative=False)
        time.sleep(flight_time)
...
def set_pid_values(scf, propeller_size=None, with_cage=False):
    ...
    if propeller_size == 2:
        ...
        #
        cf.param.set_value('pid_rate.roll_kp', '40')
        cf.param.set_value('pid_rate.roll_ki', '50.0')
        cf.param.set_value('pid_rate.roll_kd', '1.0')
        cf.param.set_value('pid_rate.pitch_kp', '40')
        cf.param.set_value('pid_rate.pitch_ki', '50.0')
        cf.param.set_value('pid_rate.pitch_kd', '1.0')
