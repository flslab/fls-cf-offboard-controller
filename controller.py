...
def set_pid_values(scf, propeller_size=None, with_cage=False):
    ...
    if propeller_size == 2:
        ...
        #
        cf.param.set_value('pid_rate.roll_kp', '50.0')
        cf.param.set_value('pid_rate.roll_ki', '100.0')
        cf.param.set_value('pid_rate.roll_kd', '2.5')
        cf.param.set_value('pid_rate.pitch_kp', '50.0')
        cf.param.set_value('pid_rate.pitch_ki', '100.0')
